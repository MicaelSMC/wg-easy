...
iptables -t nat -A POSTROUTING -s 10.0.0.1 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
iptables -t nat -D POSTROUTING -s 10.0.0.1 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
